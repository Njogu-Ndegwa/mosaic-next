...
//                   </div>
//                   <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-3" >Sign In</button>
//                 </div>
//               </form>
//               {/* Footer */}
...
const handleSubmit = (values: any, { setSubmitting }: any) => {
  ...
  console.log(values);
  // After submission, set submitting to false
  setSubmitting(false);
};
